...
\begin{align*}
\load \leq \frac{\ln \ln n}{\ln d}+ O(h)
\end{align*}
w.h.p.~for all $t$ \cite{ABKU99} \cite{BCSV06}.
\end{theorem}

This implies a gap of $O\left(\ln \ln n \right)$ for arbitrarily large $m$, which is remarkable in several ways:
\begin{compactitem}
