...
\end{align}
and $n$ be large enough such that 
\begin{align}
L \in \Theta \left(\ln \ln n \right)
\end{align}
Then, 
\begin{align}
...
For any constant $\alpha > 0$, let 
\begin{align}
L = \left\lceil{\frac{\ln\log_2 n + \ln\left(1+\alpha\right)}{d\cdot \ln \Phi_d}}\right  \rceil +1
\end{align}
and $n$ be large enough such that
\begin{align}
L \in \Theta\left(\frac{\ln\ln n}{d\cdot \ln \Phi_d}\right)
\end{align}
